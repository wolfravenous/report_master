...
RSpec.feature "Users can view reports" do
  scenario "with the report details" do
    ...
    report = FactoryGirl.create(:report, name: "Jill", comment: "Some personal Comments", gender: "female", classwork: "83.5", assessment: "83.5", participate: "83.5", subject_id: 1, unit_id: 1)
