...
RSpec.feature "Users can delete reports" do
  scenario "successfully" do
    ...
    FactoryGirl.create(:report, name: "Jimmy Jones", comment: "Some personal Comments", gender: "female", classwork: "88", assessment: "92", participate: "90", subject_id: 1, unit_id: 1)
