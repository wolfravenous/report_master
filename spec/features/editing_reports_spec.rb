...
RSpec.feature "Users can edit existing reports" do
  before do
    ...
    FactoryGirl.create(:report, name: "Jimmy", comment: "Some personal Comments", gender: "female", classwork: "88", assessment: "92", participate: "90", subject_id: 1, intro_id: 1, initial_id: 1, ending_id: 2, future_id: 1)
